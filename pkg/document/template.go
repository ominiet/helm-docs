...
func getRequirementsTableTemplates() string {
	...
	requirementsSectionBuilder.WriteString("| Repository | Name | Version | Locked Version |\n")
	...
	requirementsSectionBuilder.WriteString("\n| {{ .Repository }} | {{ .Alias }}({{ .Name }}) | {{ .Version }} | {{ with .LockedVersion }}{{ . }}{{ end }} |")
	requirementsSectionBuilder.WriteString("    {{- else }}")
	requirementsSectionBuilder.WriteString("\n| {{ .Repository }} | {{ .Name }} | {{ .Version }} | {{ with .LockedVersion }}{{ . }}{{ end }} |")
	requirementsSectionBuilder.WriteString("    {{- end }}")
	requirementsSectionBuilder.WriteString("  {{- end }}")
	requirementsSectionBuilder.WriteString("{{ end }}")
